...
class JobNormalizer:
    ...
    def normalize(
        ...
        content_for_hash = f"{normalized_title}|{normalized_company}|{normalized_description[:1000]}"
    ...
    def _normalize_company(self, company: str) -> str:
        ...
        company = re.sub(r'\s+(inc|llc|corp|corporation|ltd|limited)\.?$', '', company, flags=re.IGNORECASE)

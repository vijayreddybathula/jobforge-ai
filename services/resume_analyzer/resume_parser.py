...
class ResumeParser:
    ...
    def _parse_sections(self, text: str) -> Dict[str, Any]:
        ...
        """
        sections = {"contact": {}, "experience": [], "education": [], "skills": [], "summary": ""}
        ...
        for line in lines:
            ...
            if any(
                keyword in line_lower for keyword in ["experience", "work experience", "employment"]
            ):
                current_section = "experience"
            elif any(keyword in line_lower for keyword in ["education", "academic"]):
                current_section = "education"
            elif any(
                keyword in line_lower for keyword in ["skills", "technical skills", "competencies"]
            ):
    ...
    def parse_resume(self, file_content: bytes, file_name: str, user_id: str) -> Dict[str, Any]:
        """Parse resume file.

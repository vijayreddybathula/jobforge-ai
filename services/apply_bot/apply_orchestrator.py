...
class ApplyOrchestrator:
    ...
    def start_apply_session(
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                events.append({"event": "NAVIGATING", "details": {"url": job_url}})

                page.goto(job_url, wait_until="networkidle", timeout=30000)
                time.sleep(2)

                events.append({"event": "PAGE_LOADED", "details": {"title": page.title()}})

                # Detect platform and apply strategy
                platform = self._detect_platform(page)
                events.append({"event": "PLATFORM_DETECTED", "details": {"platform": platform}})
                ...
                events.append(
                    {
                        ...
                        "details": {
                            "message": "Ready for human review. Please review and submit manually."
                        },
                    }
                )
                ...
                events.append({"event": "ERROR", "details": {"error": str(e)}})
                browser.close()
                raise
    ...
    def _fill_form(
        self, page: Page, user_data: Dict[str, Any], artifacts: Dict[str, str], platform: str
    ) -> List[Dict[str, Any]]:
    ...
    def _upload_resume(
        self, page: Page, resume_path: str, platform: str
